.<?php
ob_start();
$token = "483038713:AAHv-9o04RjAygevIrFefZEoLlKxK8keZcc";
...
[['text'=>"🔺 - نشر الستة - 🔺",'callback_data'=>"send"],
['text'=>"🔻 - حذف الستة - 🔻",'callback_data'=>"delete"]],[
['text'=>"🔄 - رفع الستة - 🔄",'callback_data'=>"up"]
],
[['text'=>"🔋 - عرض قنوات المشاركة - 🔋",'callback_data'=>"test"]],
[['text'=>"🔘 - نشر كود - 🔘",'callback_data'=>"sendcode"],
['text'=>"💠 - نشر ماركداون - 💠",'callback_data'=>"sendlink"]],
[['text'=>"🔣 - نشر html - 🔣",'callback_data'=>"sendhtml"],['text'=>"⏩ - نشر اعاده توجيه - ⏪",'callback_data'=>"sendfwd"]],
[['text'=>"🔘 - نشر كل الكودات - 🔘",'callback_data'=>"sendallcode"]],
...
'inline_keyboard'=>[
[['text'=>"➕ - صنع منشور - 🔘",'callback_data'=>"start"]],
[['text'=>"🔺 - نشر الستة - 🔺",'callback_data'=>"send"],['text'=>"🔻 - حذف الستة - 🔻",'callback_data'=>"delete"]],[['text'=>"🔄 - رفع الستة - 🔄",'callback_data'=>"up"]],
[['text'=>"🔋 - عرض قنوات المشاركة - 🔋",'callback_data'=>"test"]],
...
bot('editmessagetext',[
'chat_id'=>$chat_id, 
'text'=>"⏳ - جاري رفع الستة انتضر قليلا... - ⌛️",
"message_id"=>$message_id,
]);
unlink("data/lista.txt");
for($d=0;$d<count($getlista);$d++){
...
bot('editmessagetext',[
'chat_id'=>$chat_id, 
'text'=>"🔝 - تم رفع الستة في جميع القنوات ياصديقي - ☑️",
"message_id"=>$message_id,
'reply_markup'=>$back
]);
}
...
bot("sendMessage",[
"chat_id"=>$chat_id,
"text"=>"⚠️ قنَاتُكَ لَمـ تُضَافـ !
 أضِفـ البُوتـ ".$hadll." إدَارِي بِقنَاتُك ثُمَّ أعِد إرسَال مَعرف قَناتُك .
"
]);
}
...
bot("sendMessage",[
"chat_id"=>$chat_id,
"text"=>"⚠️ | المَعذِرة عَدد مُشتركي قناتك أقلّ من ".$hadlll
]);
}
...
bot("sendMessage",[
"chat_id"=>$chat_id,
"text"=>"⚠️ | المَعذِرة قناتك قامَت بمُخالفة شُروط الِسـتـة وتـ⁉️ـم حَظرُها .
